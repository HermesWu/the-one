<template>
  <div class="t-popover-wrapper" ref="popover">
    <div ref="contentWrapper" v-if="visible" class="t-popover-content-wrapper" :class="[`position-${position}`]">
  ...
  export default {
    ...
    methods: {
      ...
      positionContent() {
        ...
        (this.popoverContainer||document.body).appendChild(contentWrapper)
